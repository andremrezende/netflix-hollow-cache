...
public class AgenciaAPIHashIndex extends AbstractHollowHashIndex<AgenciaAPI> {

    public AgenciaAPIHashIndex(HollowConsumer consumer, String queryType, String selectFieldPath, String... matchFieldPaths) {
        super(consumer, true, queryType, selectFieldPath, matchFieldPaths);
    }

    public AgenciaAPIHashIndex(HollowConsumer consumer, boolean isListenToDataRefresh, String queryType, String selectFieldPath, String... matchFieldPaths) {
    ...
    public Iterable<Agencia> findAgenciaMatches(Object... keys) {
        HollowHashIndexResult matches = idx.findMatches(keys);
        if(matches == null) return Collections.emptySet();

        return new AbstractHollowOrdinalIterable<Agencia>(matches.iterator()) {
            public Agencia getData(int ordinal) {
